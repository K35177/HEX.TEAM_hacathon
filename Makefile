...
test: $(BUILD_DIR)/protocol_tests $(BUILD_DIR)/wav_tests $(BUILD_DIR)/fsk_tests $(BUILD_DIR)/transfer_tests $(BUILD_DIR)/framing_tests $(BUILD_DIR)/sha256_tests $(BUILD_DIR)/acoustic-transfer
...
clean:
	rm -f $(BUILD_DIR)/acoustic-transfer $(BUILD_DIR)/protocol_tests $(BUILD_DIR)/wav_tests $(BUILD_DIR)/fsk_tests $(BUILD_DIR)/transfer_tests $(BUILD_DIR)/framing_tests $(BUILD_DIR)/sha256_tests
