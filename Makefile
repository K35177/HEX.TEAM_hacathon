...
test: $(BUILD_DIR)/protocol_tests$(EXEEXT) $(BUILD_DIR)/wav_tests$(EXEEXT) $(BUILD_DIR)/fsk_tests$(EXEEXT) $(BUILD_DIR)/transfer_tests$(EXEEXT) $(BUILD_DIR)/framing_tests$(EXEEXT) $(BUILD_DIR)/sha256_tests$(EXEEXT) $(BUILD_DIR)/audio_processing_tests$(EXEEXT) $(BUILD_DIR)/profile_tests$(EXEEXT) $(BUILD_DIR)/channel_simulator_tests$(EXEEXT) $(BUILD_DIR)/acoustic-transfer$(EXEEXT)
...
clean:
	rm -f $(BUILD_DIR)/acoustic-transfer$(EXEEXT) $(BUILD_DIR)/acoustic-client$(EXEEXT) $(BUILD_DIR)/protocol_tests$(EXEEXT) $(BUILD_DIR)/wav_tests$(EXEEXT) $(BUILD_DIR)/fsk_tests$(EXEEXT) $(BUILD_DIR)/transfer_tests$(EXEEXT) $(BUILD_DIR)/framing_tests$(EXEEXT) $(BUILD_DIR)/sha256_tests$(EXEEXT) $(BUILD_DIR)/audio_processing_tests$(EXEEXT) $(BUILD_DIR)/profile_tests$(EXEEXT) $(BUILD_DIR)/channel_simulator_tests$(EXEEXT)
