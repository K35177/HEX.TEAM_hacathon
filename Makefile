...
BUILD_DIR := build
CORE_SOURCES := src/audio/wav.cpp src/protocol/crc32.cpp src/protocol/packet.cpp src/modem/fsk.cpp src/modem/framing.cpp src/transfer/transfer.cpp
...
test: $(BUILD_DIR)/protocol_tests $(BUILD_DIR)/wav_tests $(BUILD_DIR)/fsk_tests $(BUILD_DIR)/transfer_tests $(BUILD_DIR)/framing_tests $(BUILD_DIR)/acoustic-transfer
...
clean:
	rm -f $(BUILD_DIR)/acoustic-transfer $(BUILD_DIR)/protocol_tests $(BUILD_DIR)/wav_tests $(BUILD_DIR)/fsk_tests $(BUILD_DIR)/transfer_tests $(BUILD_DIR)/framing_tests
