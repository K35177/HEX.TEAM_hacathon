...
В коде есть backend для Linux, macOS и Windows, пять профилей канала,
...
Текущая версия 0.6.1 — **лабораторный acoustic file transfer prototype**. Она умеет
...
- профили `turbo`, `wideband`, `fast`, `balanced` и `robust`;
...
|---|---:|---:|---:|---|
| `turbo` | 16-FSK | 1920 бит/с | 4096 B | быстрый режим в полосе 0,96–8,16 кГц |
